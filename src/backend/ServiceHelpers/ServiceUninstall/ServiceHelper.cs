    ...
    public static class ServiceHelper
    {
        private static string RadarrExe
        {
            get
            {
                ...
                var directory = fileInfo.Directory ?? throw new InvalidOperationException("Unable to determine assembly directory");
                return Path.Combine(directory.FullName, "Radarr.Console.exe");
            }
        }
