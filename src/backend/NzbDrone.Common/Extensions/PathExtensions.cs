...
namespace NzbDrone.Common.Extensions;
    public static class PathExtensions
    {
        ...
        public static string GetActualCasing(this string path)
        {
            ...
            var dirInfo = fileInfo.Directory ?? throw new ArgumentException("Path must have a valid directory", nameof(path));
        ...
        public static string? GetAncestorPath(this string path, string ancestorName)
        {
            ...
            {
                throw new ArgumentNullException(nameof(ancestorName));
            }
